class TestPageHeroku {
  ...
  setValueUsername(value) {
    if (value != "") cy.get("input[name='username']").type(value);
  ...
  setValuePassword(value) {
    if (value != "") cy.get("input[name='password']").type(value);
  ...
  setValueReportmissingparams(value) {
    if (value != "") cy.get("input[name='reportmissingparams']").type(value);
  ...
  setValueFormReturn(value) {
    if (value != "") cy.get("input[name='form_return']").type(value);
  ...
  setValueComments(value) {
    if (value != "") cy.get("textarea[name='comments']").type(value);
