...
class RequestDocumentType{
	...
	clickBtnNewRequestDocumentType() {
	   cy.get("button[name='BtnNewRequestDocumentType']").click();
	}
	
	verifyLengthRowsTableRequestDocumentType(rows) {
...
export default RequestDocumentType;
